...
export default function Home() {
  ...
  function handleEnquiryFocus() {
    setIsEnquiryFormActive(true);
    setIsComingSoonBannerOpen(false);
  }

  function handleEnquiryBlur(event) {
    if (!event.currentTarget.contains(event.relatedTarget)) {
      setIsEnquiryFormActive(false);
    }
  }
  ...
  return (
    ...
    >
      ...
      {isComingSoonBannerOpen && !isEnquiryOpen && !isEnquiryFormActive ? (
        <div
